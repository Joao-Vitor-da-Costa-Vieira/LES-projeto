import { confirmarTroca } from "/scripts/service/transacoes/trocasService.js";
...
document.getElementById('trocar')?.addEventListener('click', async (e) => {
    e.preventDefault();
    ...
    await confirmarTroca(usr_id, itensTroca, subtotal, tra_id, end_id);
});
